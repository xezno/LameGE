...
namespace ECSEngine.Components
{
    public class ShaderComponent : Component<ShaderComponent>
    {
        ...
        public void SetVariable(string variableName, object variableValue)
        {
            ...
            {
                Debug.Logging.Log($"Tried to set value for variable {variableName}, but null value was given.", Debug.Logging.Severity.High);
            ...
            {
                errorLog.Add(variableName);
                Debug.Logging.Log($"I don't know how to handle {variableValue.GetType().Name} yet :(", Debug.Logging.Severity.Medium);
            }
        }
